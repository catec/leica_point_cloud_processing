...
Filter::Filter(Eigen::Vector3f cloud_center,
               double leaf_size, 
               double noise_threshold, 
               double floor_threshold)
{
...
void Filter::filter_noise(double threshold, 
...
void Filter::filter_noise(Eigen::Vector3f cloud_center, 
                          double threshold, 
                          PointCloudRGB::Ptr cloud, 
                          PointCloudRGB::Ptr cloud_filtered)
{
...
void Filter::filter_floor(double threshold, 
                          PointCloudRGB::Ptr cloud, 
                          PointCloudRGB::Ptr cloud_filtered)
{
