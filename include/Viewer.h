...
public:
  ...
  void addNormalsToViewer(typename pcl::PointCloud<PointT>::Ptr cloud, typename pcl::PointCloud<CloudT>::Ptr normals,
...
template <typename PointT>
inline void Viewer::addPCToViewer(typename pcl::PointCloud<PointT>::Ptr cloud, const pc_color& color,
                                  const std::string& name)
{
  configViewer();
...
template <typename PointT>
inline void Viewer::addPCToViewer(typename pcl::PointCloud<PointT>::Ptr cloud, const std::string& name)
{
  configViewer();
  _viewer->resetStoppedFlag();
...
inline void Viewer::addNormalsToViewer(typename pcl::PointCloud<PointT>::Ptr cloud,
                                       typename pcl::PointCloud<CloudT>::Ptr normals, const std::string& name)
{
  _viewer->resetStoppedFlag();
